        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentAuthor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UpdateRequest_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.InsertData(
                table: "Documents",
                columns: new[] { "Id", "Author", "AverageRate", "Description", "Image", "IsPublic", "Title", "UpdateDate" },
                values: new object[,]
                {
                    { 1, "Unknow", 0.0, "This comprehensive reference to the C# language is designed to help you get up to speed on C#. Author Eric Gunnerson, a developer on Microsoft's C# design team, has logged many hours writing and testing C# code. ", null, true, "Introduction to C#", new DateTime(2021, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "Unknow", 0.0, "A Practical Introduction to Clean Coding for Beginners", null, false, "Clean Code", new DateTime(2021, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
